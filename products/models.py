...
class Material(models.Model):
    name = models.CharField(max_length=100, unique=True)
    material_group = models.ForeignKey(MaterialGroup, on_delete=models.RESTRICT)
...
class MaterialOrder(models.Model):
    item = models.ForeignKey(SupplierMaterial, on_delete=models.RESTRICT)
...
class BOMItem(models.Model):
    bom_id = models.ForeignKey(ProductBOM, on_delete=models.RESTRICT)
    material = models.ForeignKey(Material, on_delete=models.RESTRICT)
    quantity = models.DecimalField(max_digits=10, decimal_places=2)
